...
//         x: 0,
//         y: 0,
//         url: 'https://6439.iiio.top/addons/wx_shop/plugin/app/static/material/haibao.png',
//       },
//       {
//         width: 160,
//         height: 160,
//         x: 290,
//         y: 780,
//         url: 'https://6439.iiio.top/addons/wx_shop/plugin/app/static/material/daipingjia.png',
//       }
//     ]
...
Page({
  data: {
    ...
    interval: 2000,
    duration: 500,
    image:'https://6439.iiio.top/attachment/images/96/2019/11/Y35I3hv09bi259iJH0c3mI23YQnVtm.png'
  },
  onPosterSuccess(e) {
    console.log(e);
    var that = this;
  ...
  myTab: function (t) {
    ...
    if (i =="shiti"){
      ...
      a.get("share/share_backgrounds", {}, function (b) {
        console.log(b);
        if (b.error == 0) {
          e.setData({ background: b.list});
        }
      })
    }
